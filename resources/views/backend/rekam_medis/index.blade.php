...
<div class="container mt-5" style="max-width: 10000px"> {{-- Biar nggak full width --}}
  <div class="card shadow-sm">
    <div class="d-flex justify-content-between align-items-center px-4 pt-3">
      ...
      <a href="{{ route('rekam_medis.create') }}" class="btn btn-primary">Tambah Data</a>
    </div>
            ...
            <td>
              <div class="dropdown">
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item" href="{{ route('rekam_medis.edit', $data->id) }}">
                    <i class="bx bx-edit-alt me-2"></i> Edit
                  </a>
                  <form action="{{ route('rekam_medis.destroy', $data->id) }}" method="POST" onsubmit="return confirm('Yakin mau hapus?')">
                    @csrf
                    @method('DELETE')
